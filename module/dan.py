...
from module.kernels import optimal_kernel_combinations
...
class MultipleKernelMaximumMeanDiscrepancy(nn.Module):
    ...
    def forward(self, z_s: torch.Tensor, z_t: torch.Tensor) -> torch.Tensor:
        ...
        if not self.quadratic_program:
            ...
            #print('feature:'+str(features)) torch.Size([32, 128, 768])
            #print('kernel_matrix:'+str(kernel_matrix.shape)) torch.Size([32, 32, 768])
            #print('index_matrix:'+str(self.index_matrix.shape)) torch.Size([32, 32])
