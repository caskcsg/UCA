...
if __name__=="__main__":
    ...
    parser.add_argument('--index_name', default="id", type=str)
    parser.add_argument('--source_file', default="/workspace/hateful_memes/TLM/train_twitter.csv", type=str)
    parser.add_argument('--target_file', default="/workspace/hateful_memes/TLM/train_hateful.csv", type=str)
    parser.add_argument('--output_dir', default="/workspace/hateful_memes/TLM/", type=str)
